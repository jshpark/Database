                    ...
                    do{
                        ...
                        switch (tableChoice){
                            case 1:
                                ...
                                System.out.format("%15s%125s%30s%30s%20s%20s%20s%20s%20s%20s%20s", "Product ID", "Product Name", "Category", "SubCategory", "Model Number", "Manufacturer", "Stock", "Price", "Warranty", "Membership Only", "Shipping ID");
                                System.out.println();
                                System.out.println("_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________");
                                while (product.next()){
                                    int prodid = product.getInt(1);
                                    String prodname = product.getString(2);
                                    String cat = product.getString(3);
                                    String subcat = product.getString(4);
                                    String modn = product.getString(5);
                                    String manu = product.getString(6);
                                    int stock = product.getInt(7);
                                    int price = product.getInt(8);
                                    String warr = product.getString(9);
                                    int memb = product.getInt(10);
                                    int shipid = product.getInt(11);
                                    System.out.format("%15s%125s%30s%30s%20s%20s%20s%20s%20s%20s%20s", prodid, prodname, cat, subcat, modn, manu, stock, price, warr, memb, shipid);
                                    System.out.println();
                                }
                                case2 = false;
                                break;
                            case 2:
                                ...
                                System.out.format("%15s%125s%20s%50s%20s%20s", "Product ID", "Product Name", "Color", "Dimension", "Type", "SubCategoryID");
                                System.out.println();
                                System.out.println("_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________");
                                System.out.println();
                                while (bed.next()){
                                    int bedid = bed.getInt(1);
                                    String bedname = bed.getString(2);
                                    String bedcolor = bed.getString(3);
                                    String beddimen = bed.getString(4);
                                    String bedtype = bed.getString(5);
                                    int bedsubid = bed.getInt(6);
                                    System.out.format("%15s%125s%20s%50s%20s%20s", bedid, bedname, bedcolor, beddimen, bedtype, bedsubid);
                                    System.out.println();
                                }
                                System.out.println();
                                case2 = false;
                            ...
                            case 3:
                                ...
                                System.out.format("%15s%125s%20s%50s%20s%40s%20s", "Product ID", "Product Name", "Frame Size", "Tire Size", "Color", "Height for User", "SubCategoryID");
                                System.out.println();
                                System.out.println("_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________");
                                System.out.println();
                                while (bike.next()){
                                    int bikeid = bike.getInt(1);
                                    String bikename = bike.getString(2);
                                    String bikeframe = bike.getString(3);
                                    String biketire = bike.getString(4);
                                    String bikecolor = bike.getString(5);
                                    String bikeheight = bike.getString(6);
                                    int bikesubid = bike.getInt(7);
                                    System.out.format("%15s%125s%20s%50s%20s%40s%20s", bikeid, bikename, bikeframe, biketire, bikecolor, bikeheight, bikesubid);
                                    System.out.println();
                                }
                                System.out.println();
                                case2 = false;
                    ...
                    do{
                        ...
                        switch (choice2){
                            ...
                            case 4:
                                ...
                                System.out.format("%50s%15s%15s%15s", "SubCategory", "Max Price", "Min Price", "Average Price");
                                System.out.println();
                                ...
                                System.out.println();
                                while (rs.next()) {
                                    String resultsubCat = rs.getString(1);
                                    float resultmaxPrice = rs.getFloat(2);
                                    float resultminPrice = rs.getFloat(3);
                                    float resultavgPrice = rs.getFloat(4);
//                                    System.out.println(resultsubCat + "   Max Price: " + resultmaxPrice + "   Min Price: " + resultminPrice + "   Avg Price:" + resultavgPrice);
                                    System.out.format("%50s%15s%15s%15s", resultsubCat, resultmaxPrice, resultminPrice, resultavgPrice);
                                    System.out.println();
                                }
