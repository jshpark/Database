...
public class ChoiceThree {
    ...
    public void Action(Connection connection) throws SQLException {
        ...
        createIndex.executeUpdate("CREATE INDEX subCat ON Products(ProductID, SubCategory)");
        try (Statement statement = connection.createStatement()) {
            ...
            try {
                ...
                do {
                    ...
                    int tempCheck = 0;
                    PreparedStatement checkExist = connection.prepareStatement("SELECT ProductID FROM subCat WHERE ProductID = ?");
                ...
                PreparedStatement getSubCat = connection.prepareStatement("SELECT SubCategory FROM subCat WHERE ProductID = ?");
        ...
        Statement deleteIndex = connection.createStatement();
        deleteIndex.executeUpdate("ALTER TABLE Products DROP INDEX subCat");
    }
